...
window.CTI = {
  ...
  STORIES: [
 {
  ...
  "tags": [
   [
    "crit",
    "Google Chrome 153 · CVE-2026-87491 · V8 out-of-bounds write · Exploited in the wild"
   ],
   [
    "high",
    "All Sectors · Second Chrome zero-day in six days · Patched Sep 8, 2026"
   ]
  ],
  "title": "Google patches a second exploited V8 zero-day within six days — CVE-2026-87491, the seventh actively exploited Chrome zero-day of 2026",
  "body": "Google released Chrome 153 to the stable channel on Sep 8, 2026 with 230 security fixes, including CVE-2026-87491, an out-of-bounds write in the V8 JavaScript and WebAssembly engine that is being exploited in the wild. \"Google is aware that an exploit for CVE-2026-87491 exists in the wild,\" the company said in its advisory. NVD describes the flaw as an out-of-bounds write in V8 in Google Chrome prior to 153.0.8010.36 that allowed a remote attacker to execute arbitrary code inside the sandbox via a crafted HTML page. Google rates it Medium severity; BleepingComputer describes it as high-severity. The fix ships in 153.0.8010.36 and .37 for Windows and macOS and 153.0.8010.36 for Linux, with Android also receiving the update; Chrome on iOS is not affected. Jihyeon Jeong, a research intern at the Compsec Lab at Seoul National University, reported the flaw on Aug 6, 2026 and received a $2,500 bug bounty. BleepingComputer notes the patched builds began rolling out two days after the report reached Google. This is the seventh actively exploited Chrome zero-day Google has patched in 2026, and CyberInsider records it as the second addressed in under five days, following CVE-2026-85046 on Sep 3. Google has published no exploitation detail, targeting information or attribution, and states that access to bug details and links may be kept restricted until a majority of users are updated, and that restrictions may persist where the bug exists in a third-party library other projects depend on. The wider release also fixes five Critical flaws: four in WebGL — use-after-free CVE-2026-87464 and CVE-2026-87488, out-of-bounds write CVE-2026-87438 and buffer overflow CVE-2026-87527 — and a use-after-free in the Cast component, CVE-2026-87628. OffSeq counts 41 further high-severity defects. The Hacker News reports Google itself reported 195 of the 230 flaws addressed, and that one high-severity use-after-free in WebPackaging, CVE-2026-87639, is credited to OpenAI Codex Security. Windows Report notes Chrome 153 also moves the browser to a two-week release cycle. Chromium-derived browsers including Microsoft Edge, Brave, Opera and Vivaldi inherit the defect and need their own vendor releases.",
  "src": "Google Chrome release advisory (Sep 8, 2026), NIST NVD, Help Net Security, BleepingComputer, SecurityWeek, The Hacker News, CyberInsider, Bitdefender, gbhackers, Windows Report, OffSeq — Sep 8–9, 2026"
 },
 {
  "key": "sapsep",
  "badge": "new",
  "tags": [
   [
    "crit",
    "SAP Security Patch Day · CVE-2026-44756 · CVSS 10.0 · Pre-authentication memory corruption"
   ],
   [
    "high",
    "All Sectors · 19 new notes, four Critical · Released Sep 8, 2026"
   ]
  ],
  "title": "SAP ships 19 security notes with four Critical, led by a pre-authentication CVSS 10.0 memory-corruption flaw in the kernel request path",
  "body": "SAP released 19 new security notes and one update to a previously released note on its September 2026 Security Patch Day, Sep 8, 2026, including four rated Critical. The most severe is CVE-2026-44756, a memory-corruption flaw in SAP Extended Passport (EPP) processing tracked under SAP Note 3747649, with a CVSS 3.1 score of 10.0. Pathlock describes it as unauthenticated and sitting in the core request-processing path almost every SAP system relies on, and states the affected surface is every SAP NetWeaver AS ABAP and Java kernel below the patched level plus standalone and embedded SAP Web Dispatcher version 9.16 specifically, while other Web Dispatcher versions and the Web Dispatcher bundled with SAP HANA Extended Application Services are not affected. Pathlock attributes the defect to a missing boundary check during deserialization of EPP data, where an externally supplied length field is trusted without validation. Pathlock notes the SAP note's own terminology spans buffer overflow, heap overflow and dangling-pointer conditions, and that the flawed condition can be triggered before authentication takes place. securityonline.info records the affected versions as KRNL64NUC 7.22, KRNL64UC 7.22 to 8.04, WEBDISP 9.16 through 9.20 and KERNEL 7.22 through 9.20. The second Critical issue is CVE-2026-58240 (CVSS 9.8), a missing authentication check in the SAP NetWeaver Message Server under SAP Note 3759472, affecting KERNEL versions 9.16, 9.18, 9.19 and 9.20. Onapsis, which published the note in collaboration with SAP's ORL team, states the Message Server insufficiently validates the authenticity of internal application server components during registration, so unauthenticated attackers with network access can register unauthorized components inside the application environment. The third is CVE-2026-76969 (CVSS 9.4), a credential-disclosure flaw in multitenant applications using the SAP Cloud Application Programming Model library @sap/cds-mtxs, affecting versions up to 1.18.3, 2.7.6, 3.9.6 and 4.0.2. The fourth, reported by AiCybr, is CVE-2026-66768, an improper-access-control flaw in SAP GUI for Java. SAP Note 3771065, carrying a CVSS score of 10.0, is an update to a critical SAP Commerce Cloud Data Hub Adapter note first released on the August Patch Day; Onapsis reports the updated note states unmodified SAP Commerce Cloud environments are not exposed to the improper-authorization vulnerability by default, and provides an FAQ document to verify the setup. High-severity fixes include CVE-2026-76958, an 8.5-rated XXE flaw in SAP Integration Suite Trading Partner Management, insecure deserialization in SAP NetWeaver Business Client, memory corruption in SAP NetWeaver Application Server for ABAP and ABAP Platform, and CRLF injection in SAP Commerce Cloud Search and Navigation. SAP also republished CVE-2026-58243, a high-severity privilege-escalation flaw in SAP ABAP Developer Tools first addressed in August, under Security Note 3772411. Medium-severity notes cover SQL injection, SSRF, clickjacking, CSRF, information disclosure, authorization bypass and an Apache Log4j-related misconfiguration. Named examples are CVE-2026-44766, a 6.5-rated SQL injection in SAP S/4HANA Intercompany Matching and Reconciliation, three CSRF flaws in SAP S/4HANA Finance for Advanced Payment Management, and CVE-2026-76962, a missing authorization check in the Manage Bank Chains application. securityonline.info reports SAP has recorded no active in-the-wild exploitation or public proof-of-concept code for these vulnerabilities.",
  "src": "SAP Security Patch Day (Sep 8, 2026), Onapsis, Pathlock, AiCybr, CybersecurityNews, Cryptika, cyberpress.org, securityonline.info — Sep 8–9, 2026"
 },
 {
  "key": "fortinetsep",
  "badge": "new",
  "tags": [
   [
    "high",
    "Fortinet · CVE-2026-84390 / CVE-2026-84388 · CVSS 9.6 / 9.1 · No reported exploitation"
   ],
   [
    "med",
    "Information Technology · 10 flaws patched · Released Sep 8, 2026"
   ]
  ],
  "title": "Fortinet patches 10 flaws including a JWT authentication bypass in FortiMonitorOnSight and a browser-traffic proxy flaw in its privileged-access Chrome extension",
  "body": "Fortinet released patches for 10 vulnerabilities across its products on Tuesday Sep 8, 2026, including two rated critical. CVE-2026-84390 (CVSS 9.6) is described as an inclusion of sensitive information in source code affecting the FortiMonitorOnSight web portal; a remote, unauthenticated attacker could exploit it to bypass authentication via a forged or reused JSON Web Token. CVE-2026-84388 (CVSS 9.1) is an improper authentication issue in the Fortinet Privileged Access Agent Chrome extension; Fortinet explains that a remote, unauthenticated attacker may exploit it to proxy a user's browser traffic if the user visits a malicious website. Remediation for the second flaw spans two components: Fortinet states that \"remediation for this issue required coordinated changes in two components: FortiPAM and the Fortinet Privileged Access Agent Chrome extension. To be fully secure, customers should upgrade FortiPAM to 1.9.1 or 1.8.4, and ensure the Chrome extension is at version 8.0.1.123 or above.\" Fortinet also patched high-severity flaws in FortiSandbox (CVE-2026-26084) and in the FortiOS and FortiProxy Agentless ZTNA portal (CVE-2026-84393) that could allow attackers to access sensitive information and perform machine-in-the-middle attacks respectively. The remaining vulnerabilities are medium- and low-severity issues in FortiManager, FortiAnalyzer, FortiSandbox, FortiSOAR, FortiClient for Windows, FortiSIEM, FortiOS, FortiProxy and FortiPAM. OffSeq records that no known exploitation in the wild has been reported by Fortinet.",
  "src": "Fortinet PSIRT advisories (Sep 8, 2026), SecurityWeek, OffSeq Threat Radar, CloudLink — Sep 8–9, 2026"
 },
 {
  "key": "patchtuesdaysep",
  "badge": "new",
 ...
 },
 {
  ...
  "tags": [
   [
    "crit",
    "Microsoft Defender · CVE-2026-69414 ShieldBreak · Patched Sep 5 · Patch bypassed by ShieldCrash"
   ],
   [
    "high",
    "All Sectors · Public PoC · Second bypass in the same component"
   ]
  ],
  "badge": "updated",
  ...
  CVES: [
 {
  ...
  "sub": "V8 out-of-bounds write — arbitrary code execution inside the Chrome sandbox via a crafted HTML page; Google rates Medium, BleepingComputer high. Fixed in 153.0.8010.36/.37. No CVSS published in the sources reviewed"
 },
 {
  "key": "chrome87491",
  "level": "high",
  ...
  "score": "",
  "flags": [],
  "sub": "WebGL use-after-free — one of five Critical flaws in the same release, not reported as exploited"
 },
 {
  "key": "chrome87491",
  "level": "high",
  ...
  "score": "",
  "flags": [],
  "sub": "WebGL use-after-free — Critical, not reported as exploited"
 },
 {
  "key": "chrome87491",
  "level": "high",
  ...
  "score": "",
  "flags": [],
  "sub": "WebGL out-of-bounds write — Critical, not reported as exploited"
 },
 {
  "key": "chrome87491",
  "level": "high",
  ...
  "score": "",
  "flags": [],
  "sub": "WebGL buffer overflow — Critical, not reported as exploited"
 },
 {
  "key": "chrome87491",
  "level": "high",
  ...
  "score": "",
  "flags": [],
  "sub": "Cast component use-after-free — Critical, not reported as exploited"
 },
 {
  "key": "chrome87491",
  "level": "med",
  ...
  "score": "",
  "flags": [],
  "sub": "WebPackaging use-after-free — high severity, credited to OpenAI Codex Security"
 },
 {
  "key": "sapsep",
  "level": "crit",
  ...
  "score": "10.0",
  "flags": [],
  "sub": "SAP Extended Passport processing memory corruption (Note 3747649) — pre-authentication, in the kernel request-processing path; every NetWeaver AS ABAP and Java kernel below the patched level plus Web Dispatcher 9.16"
 },
 {
  "key": "sapsep",
  "level": "crit",
  ...
  "score": "9.8",
  "flags": [],
  "sub": "SAP NetWeaver Message Server missing authentication (Note 3759472) — unauthenticated attacker can register an unauthorized application server component; KERNEL 9.16, 9.18, 9.19, 9.20"
 },
 {
  "key": "sapsep",
  "level": "crit",
  ...
  "score": "9.4",
  "flags": [],
  "sub": "SAP CAP multitenancy library @sap/cds-mtxs credential disclosure — versions up to 1.18.3, 2.7.6, 3.9.6, 4.0.2"
 },
 {
  "key": "sapsep",
  "level": "crit",
  ...
  "score": "",
  "flags": [],
  "sub": "SAP GUI for Java improper access control — fourth Critical note; no CVSS in the sources reviewed"
 },
 {
  "key": "sapsep",
  "level": "high",
  ...
  "score": "8.5",
  "flags": [],
  "sub": "SAP Integration Suite Trading Partner Management XXE — file exposure, server-side requests and XML processing disruption"
 },
 {
  "key": "sapsep",
  "level": "high",
  ...
  "score": "",
  "flags": [],
  "sub": "SAP ABAP Developer Tools privilege escalation — republished under Note 3772411, originally August 2026 Patch Day"
 },
 {
  "key": "sapsep",
  "level": "med",
  ...
  "score": "6.5",
  "flags": [],
  "sub": "SAP S/4HANA Intercompany Matching and Reconciliation SQL injection"
 },
 {
  "key": "fortinetsep",
  "level": "crit",
  ...
  "score": "9.6",
  "flags": [],
  "sub": "FortiMonitorOnSight web portal — sensitive information in source code allows an unauthenticated attacker to bypass authentication with a forged or reused JWT"
 },
 {
  "key": "fortinetsep",
  "level": "crit",
  ...
  "score": "9.1",
  "flags": [],
  "sub": "Fortinet Privileged Access Agent Chrome extension improper authentication — an unauthenticated attacker can proxy a user's browser traffic if the user visits a malicious site; needs FortiPAM 1.9.1/1.8.4 and extension 8.0.1.123+"
 },
 {
  "key": "fortinetsep",
  "level": "high",
  ...
  "score": "",
  "flags": [],
  "sub": "FortiSandbox — access to sensitive information; no CVSS in the sources reviewed"
 },
 {
  "key": "fortinetsep",
  "level": "high",
  ...
  "score": "",
  "flags": [],
  "sub": "FortiOS and FortiProxy Agentless ZTNA portal — machine-in-the-middle; no CVSS in the sources reviewed"
 },
 {
  "key": "patchtuesdaysep",
  "level": "crit",
 ...
 },
 {
  ...
  "score": "9.8",
  "flags": [],
  "sub": "Remote Desktop Services use-after-free RCE — remote, unauthenticated, no user interaction. ZDI notes Microsoft describes it as requiring an in-network attacker while the CVSS vector still says Network"
 },
 {
  "key": "patchtuesdaysep",
  "level": "high",
 ...
 },
 {
  ...
  "score": "9.8",
  "flags": [],
  "sub": "Windows Netlogon RCE — unauthenticated crafted packet to a service running on every domain controller; CrowdStrike notes code execution on a DC means NTDS.dit, Kerberos keys and forged authentication artifacts"
 },
 {
  "key": "patchtuesdaysep",
  "level": "crit",
  ...
  "score": "9.8",
  "flags": [],
  "sub": "Windows SSTP RCE — unauthenticated packet to the SSTP listener, typically exposed on TCP/443 for RRAS remote-access VPN; no prior network access needed"
 },
 {
  "key": "patchtuesdaysep",
  "level": "high",
  ...
  SOURCES: [
 {
  ...
  "links": [
   {
    "label": "Chrome Releases — Stable Channel Update for Desktop (Sep 8, 2026)",
    "url": "https://chromereleases.googleblog.com/2026/09/stable-channel-update-for-desktop.html"
   },
   {
    "label": "Help Net Security — Google fixes yet another actively exploited Chrome zero-day (CVE-2026-87491)",
    "url": "https://www.helpnetsecurity.com/2026/09/09/google-chrome-cve-2026-87491-zero-day-flaw/"
   },
   {
    "label": "BleepingComputer — Google patches seventh Chrome zero-day exploited in attacks this year",
    "url": "https://www.bleepingcomputer.com/news/security/google-patches-seventh-chrome-zero-day-exploited-in-attacks-this-year/"
   },
   {
    "label": "SecurityWeek — Chrome 153 Patches Seventh Zero-Day of 2026",
    "url": "https://www.securityweek.com/chrome-153-patches-seventh-zero-day-of-2026/"
   },
   {
    "label": "The Hacker News — Chrome V8 Zero-Day Exploited in the Wild Enables Code Execution Inside Sandbox",
    "url": "https://thehackernews.com/2026/09/chrome-v8-zero-day-exploited-in-wild.html"
   },
   {
    "label": "CyberInsider — Google fixes second actively exploited Chrome zero-day in under five days",
    "url": "https://cyberinsider.com/google-fixes-second-actively-exploited-chrome-zero-day-in-under-five-days/"
   }
  ]
 },
 {
  "group": "SAP September 2026 Security Patch Day — Sep 8, 2026",
  "links": [
   {
    "label": "SAP Security Patch Day — September 2026",
    "url": "https://support.sap.com/en/my-support/knowledge-base/security-notes-news.html"
   },
   {
    "label": "Onapsis — SAP Security Patch Day for September 2026",
    "url": "https://onapsis.com/blog/sap-security-patch-day-september-2026/"
   },
   {
    "label": "Pathlock — SAP Security Patch Day, September 2026",
    "url": "https://pathlock.com/blog/sap-security-patch-day-september-2026/"
   },
   {
    "label": "AiCybr — SAP September 2026 Patch Day Fixes 4 Critical Flaws, Including CVSS 10.0 EPP Bug",
    "url": "https://aicybr.com/blog/sap-september-2026-security-patch-day"
   },
   {
    "label": "CybersecurityNews — SAP Security Updates September 2026",
    "url": "https://cybersecuritynews.com/sap-security-updates-september-2026/"
   },
   {
    "label": "securityonline.info — September 2026 SAP Security Patch Day Fixes Critical Flaws",
    "url": "https://securityonline.info/september-2026-sap-security-patch-day/"
   }
  ]
 },
 {
  "group": "Fortinet September 2026 advisories — Sep 8–9, 2026",
  "links": [
   {
    "label": "Fortinet PSIRT advisories",
    "url": "https://fortiguard.fortinet.com/psirt"
   },
   {
    "label": "SecurityWeek — Fortinet Patches Critical Vulnerabilities in FortiMonitorOnSight, Chrome Extension",
    "url": "https://www.securityweek.com/fortinet-patches-critical-vulnerabilities-in-fortimonitoronsight-chrome-extension/"
   },
   {
    "label": "OffSeq Threat Radar — Fortinet Patches Critical Vulnerabilities in FortiMonitorOnSight, Chrome Extension",
    "url": "https://radar.offseq.com/threat/fortinet-patches-critical-vulnerabilities-in-fortimonitoronsight-chrome-extension-c114c575ae9442dc"
   }
  ]
 },
 {
  "group": "Microsoft Defender ShieldCrash — patch bypass for CVE-2026-69414 — Sep 8–9, 2026",
  "links": [
   {
    "label": "The Hacker News — Researcher Drops New Microsoft Defender PoC Showing ShieldBreak Patch Can Be Bypassed",
    "url": "https://thehackernews.com/2026/09/researcher-drops-new-microsoft-defender.html"
   },
   {
    "label": "securityonline.info — ShieldCrash: Windows Defender 0day With Public PoC Exploit",
    "url": "https://securityonline.info/windows-defender-0day-cve-2026-69414/"
   }
  ]
 },
 {
  "group": "CISA KEV additions — Sep 8, 2026",
  "links": [
   {
    "label": "CISA — Adds Four Known Exploited Vulnerabilities to Catalog (Sep 8, 2026)",
  ...
  CORRECTIONS: [
 {
  ...
  "was": "security-dfir-feeds.opml carried two entries for the same feed URL, https://securityonline.info/feed/ — the pre-existing \"SecurityOnline.info\" row and a second \"Security Online (securityonline.info)\" row added during the Sep 8 refresh",
  "now": "The Sep 8 addition was removed and the original row kept. Three genuinely new sources were added instead — Onapsis Research Labs, Pathlock and CyberInsider, all used in this refresh — bringing the file to 166 feeds across 7 categories",
  "why": "The Sep 8 refresh added a feed that was already present, which is a process error on my side: the file should have been checked for the URL before appending. Four further entries share a display name but point at different URLs and were left alone — DFIRScience (YouTube channel and blog), Cellebrite (four separate category feeds), Security Affairs (securityaffairs.co/wordpress/feed and securityaffairs.com/feed) and DFIR Review (dfir.pubpub.org/rss.xml and dfrws.org/dfir-review/). The last two pairs look like one live feed and one legacy or non-feed URL each, but both are user or Rathbun entries and are not mine to remove."
 },
 {
  "date": "Sep 9, 2026",
  "item": "Daily refresh — three stories added, four CVEs KEV-listed, Patch Tuesday expanded",
  "was": "33 stories; CISA KEV status not recorded for the September Patch Tuesday zero-days, the Adobe Commerce flaw or the N-able flaw; the Patch Tuesday record carried the ZDI wormable count without the CrowdStrike analysis or the Malwarebytes count reconciliation",
  "now": "36 stories. Added Chrome CVE-2026-87491 (chrome87491), the SAP September Patch Day (sapsep) and the Fortinet September advisories (fortinetsep), with 19 new CVE rows and seven hunting queries between them. KEV flags added to CVE-2026-75650, CVE-2026-81963, CVE-2026-85880 and CVE-2026-86218 following CISA's four-CVE addition of Sep 8, and the three affected stories carry an update note. The Patch Tuesday record gained CrowdStrike's analysis of Netlogon CVE-2026-72982 and SSTP CVE-2026-73009 (both CVSS 9.8, both added as CVE rows), ZDI's CVSS 9.8 rating and in-network caveat for RDS CVE-2026-69525, DHCP Server CVE-2026-69510, Dustin Childs' assessment of the wormable set and of the Update Stack flaw, Malwarebytes' 964-of-974 reconciliation with 104 Critical and 860 Important, and the Windows Biometric Service count of 64. A key judgment on failed fixes was added and the set renumbered. The Manchester Airports Group record notes SecurityWeek's roughly 550 GB figure against FulcrumSec's 640 GB claim",
  "why": "Daily refresh for Wed Sep 9. The Chrome flaw is carried separately from CVE-2026-85046 rather than as an update, because it is a distinct CVE with its own advisory, researcher and fixed builds — the six-day gap between the two is itself the finding."
 },
 {
  "date": "Sep 9, 2026",
  "item": "ShieldBreak reassessed — a patch exists, and it has already been bypassed",
  "was": "ShieldBreak (CVE-2026-69414) was carried as unpatched, with the assessment that \"Microsoft has confirmed the vulnerability and is working on a fix but none is available,\" and it was retained through the Sep 8 prune specifically on the awaiting-a-fix rule",
  "now": "Microsoft patched CVE-2026-69414 in Microsoft Malware Protection Engine version 1.1.26080.3, per The Hacker News, and the researcher Chaotic Eclipse has since published ShieldCrash, a proof-of-concept assessed to be a bypass of that patch, demonstrating arbitrary file read as SYSTEM on the latest version of Windows with all supported desktop versions said to be impacted. The story badge moves to updated, severity is raised to 5, and the mitigation guidance now says to deploy engine 1.1.26080.3 while keeping the ShieldBreak compensating controls in place, because ShieldCrash has no CVE, no patch and no Microsoft statement",
  "why": "The prior assessment is now wrong in both directions — a fix shipped, and the fix does not hold. The reason to keep the story is no longer that a patch is awaited but that this is the second consecutive bypass in the same Defender component, after ShieldBreak defeated July's RoguePlanet fix. Note the researcher's claims about scope are repeated in reporting but not independently verified, and Microsoft has not commented."
 },
 {
  "date": "Sep 8, 2026",
 ...
 "shieldbreak": {
  "eyebrow": "Microsoft Defender · CVE-2026-69414 · ShieldBreak · Patched Sep 5 · Bypassed by ShieldCrash · Sep 9, 2026",
  "title": "Two consecutive patch bypasses in the same Defender component",
  "tags": [
   [
    "crit",
    "No Patch · PoC Public"
  ...
  "overview": "The assessment carried here last week — that no patch existed — is now out of date twice over: Microsoft shipped the fix in Malware Protection Engine 1.1.26080.3, and the same researcher then bypassed it. That makes ShieldCrash the second consecutive bypass in this component, after ShieldBreak itself defeated the July fix for RoguePlanet. The pattern is the thing to carry rather than any individual exploit: three exploits in three months have reached SYSTEM through the same privileged Defender processing path, and two of the three defeated a shipped fix, which is evidence that the fixes have addressed individual access routes rather than the underlying design. The researcher's own framing supports that reading, describing a missed spot rather than a new technique. Practically, the current ShieldCrash proof-of-concept demonstrates arbitrary file read as SYSTEM rather than full code execution, which is a narrower primitive than ShieldBreak's — but arbitrary file read as SYSTEM is sufficient to take the registry hives, and it is reported to work on the latest Windows across all supported desktop versions. There is no CVE, no patch and no Microsoft statement for ShieldCrash, so the compensating controls that applied to ShieldBreak still apply and should not be stood down on the strength of the September engine update. Note that Defender engine updates ship outside the Patch Tuesday cycle, so the 1.1.26080.3 fix is not evidenced by a Windows build number.",
  "technical": [
   "Update, Sep 9 — Microsoft patched CVE-2026-69414 in Microsoft Malware Protection Engine version 1.1.26080.3, per The Hacker News. Malware Protection Engine updates ship outside the monthly Patch Tuesday cycle, so a patched host is not identified by its Windows build number.",
   "ShieldCrash — a further Defender zero-day published by the researcher Chaotic Eclipse and assessed to be a patch bypass for CVE-2026-69414. Chaotic Eclipse: \"Microsoft has failed to properly patch ShieldBreak CVE-2026-69414. Under specific conditions it is still possible to trigger the exact same problem that was caused by ShieldBreak. While Microsoft fixed several things to prevent re-exploiting the issue, they missed a spot where ShieldBreak can still be exploited.\"",
   "The ShieldCrash proof-of-concept demonstrates an arbitrary file read as SYSTEM with the latest version of Windows installed, and all supported versions of the desktop operating system are said to be impacted. Both the vulnerability details and the proof-of-concept are public, per securityonline.info. No CVE identifier has been assigned in the reporting reviewed, and Microsoft had issued no statement at the time of writing.",
   "Chain of bypasses in this component: RoguePlanet (CVE-2026-50656) acknowledged Jun 16 and patched Jul 8; ShieldBreak (CVE-2026-69414) published Aug 12 as a bypass of that fix, CVE assigned Aug 14, patched in engine 1.1.26080.3; ShieldCrash published Sep 8–9 as a bypass of the ShieldBreak fix.",
  ...
  "iocs": [],
  "iocNote": "No indicators for either exploit. Both are local privilege escalations with public proof-of-concept code and no reported in-the-wild campaign, so there are no network indicators and no file hashes tied to an actor. Detection has to be behavioural — the queries below target the Defender processing path itself.",
  "mitigation": [
   "Deploy Malware Protection Engine 1.1.26080.3 or later to close CVE-2026-69414 itself. Engine updates ship outside Patch Tuesday, so confirm engine version rather than Windows build, and confirm that automatic engine updates are enabled and unblocked.",
   "Do not stand down the ShieldBreak compensating controls. ShieldCrash bypasses the 1.1.26080.3 fix, has no patch and no CVE, and is reported to work on all supported desktop Windows versions.",
   "Application control remains the effective control for both. Every exploit in this chain is a local privilege escalation that requires the attacker to run code on the host first, so restricting untrusted local code execution removes the precondition.",
   "For FCEB agencies, CISA BOD 26-04's compensating-control requirement was satisfied for CVE-2026-69414 by the engine update; ShieldCrash is a separate unpatched issue with a public proof-of-concept and should be tracked as one.",
   "Monitor the Microsoft Security Update Guide and MSRC for a ShieldCrash advisory and a CVE assignment, and treat the absence of a Microsoft statement as an open question rather than as evidence that the bypass does not work."
  ],
  "response": [
 ...
 "chrome87491": {
  "eyebrow": "Google Chrome · CVE-2026-87491 · V8 out-of-bounds write · Exploited in the wild · Patched Sep 8, 2026",
  "title": "The second exploited V8 zero-day in six days, and the rating understates it",
  "tags": [
   [
    "crit",
    "All Sectors"
  ...
  "overview": "Two things make this worth separate handling rather than a line in the Chrome story already carried here. The first is cadence: this is the second exploited V8 zero-day Google has patched in six days, after CVE-2026-85046 on Sep 3, and the seventh of 2026 — an estate that treats Chrome updates as a monthly or fortnightly task is now behind by design. The second is that the severity rating is the wrong signal. Google rates CVE-2026-87491 Medium and BleepingComputer reports it as high; either way it is exploited in the wild, which is the only fact that should drive the deployment decision. The exploit is described as executing code inside the sandbox, so on its own it is not a full host compromise — reaching the operating system requires a chained sandbox escape, which Google has not said is present. As with the Sep 3 flaw, no exploitation detail, targeting or attribution has been published and none should be expected while the rollout completes, so browser version state is the entire defensive position. The bounty of $2,500 for a flaw later found exploited in the wild is a reminder that report value and attacker value are unrelated.",
  "technical": [
   "CVE-2026-87491 — out-of-bounds write in V8, Chrome's JavaScript and WebAssembly engine. NVD: an out-of-bounds write in V8 in Google Chrome prior to 153.0.8010.36 allowed a remote attacker to execute arbitrary code inside the sandbox via a crafted HTML page. Google rates it Medium severity; BleepingComputer describes it as high-severity. No CVSS score appears in the sources reviewed.",
   "Google: \"Google is aware that an exploit for CVE-2026-87491 exists in the wild.\" No exploitation detail, victim set or attribution has been published. Google states access to bug details and links may be kept restricted until a majority of users are updated, and that restrictions may persist if the bug exists in a third-party library that other projects depend on but have not yet fixed.",
   "Fixed builds: 153.0.8010.36 and .37 for Windows and macOS, 153.0.8010.36 for Linux, with Android also updated. Bitdefender reports Chrome on iOS is not affected by this flaw.",
   "Reported by Jihyeon Jeong of the Compsec Lab at Seoul National University — BleepingComputer identifies the researcher as a research intern — on Aug 6, 2026, with a $2,500 bug bounty. BleepingComputer reports patched builds began rolling out two days after the report.",
   "Seventh actively exploited Chrome zero-day patched in 2026. CyberInsider records it as the second in under five days, following CVE-2026-85046 (V8 type confusion, patched Sep 3, KEV Sep 4), which is carried separately in this brief.",
   "The release carries 230 security fixes in total. Five are Critical: WebGL use-after-free CVE-2026-87464 and CVE-2026-87488, WebGL out-of-bounds write CVE-2026-87438, WebGL buffer overflow CVE-2026-87527, and Cast use-after-free CVE-2026-87628. OffSeq counts 41 further high-severity defects across V8, ANGLE, WebGL, PDFium, DevTools, Web Authentication, Payments, Network and GPU components.",
   "The Hacker News reports Google reported 195 of the 230 flaws itself, and credits one high-severity WebPackaging use-after-free, CVE-2026-87639, to OpenAI Codex Security.",
   "Windows Report notes Chrome 153 also moves Chrome to a two-week release cycle.",
   "Chromium-derived browsers — Microsoft Edge, Brave, Opera, Vivaldi — inherit the defect and require their own vendor releases; those had not shipped at the time of the reporting reviewed."
  ],
  "iocs": [],
  "iocNote": "No indicators published. Google confirmed an exploit exists in the wild but withholds bug detail and links until most users have updated, and published no domains, hashes or campaign information. Nothing exists to hunt on; the queries below check version and relaunch state instead.",
  "mitigation": [
   "Force Chrome to 153.0.8010.36/.37 on Windows and macOS and 153.0.8010.36 on Linux, and push the Android update, rather than waiting for the staged rollout — Google says the release can take days or weeks to reach every device.",
   "Confirm the relaunch happened. A downloaded Chrome update that has not restarted the browser is not applied, and this flaw is under active exploitation.",
   "Do not gate the rollout on the Medium severity rating. Exploitation in the wild is the operative fact, and the two outlets reviewed disagree on the severity anyway.",
   "Update Chromium-derived browsers as their vendors ship — Edge, Brave, Opera and Vivaldi inherit the V8 defect.",
   "Where a managed-browser policy exists, this is the second forced update in six days; review whether the update ring cadence matches Chrome's new two-week release cycle rather than reacting per incident."
  ],
  "response": [
   "DEFENDER XDR KQL — with no indicators to hunt, the answerable question is which managed hosts are still on a vulnerable Chrome build, and which have a patched binary installed but no relaunch. Vulnerability-management technique adapted from community work: github.com/SlimKQL/Hunting-Queries-Detection-Rules (Steven Lim, LinkedIn @0x534c).\n\n// CVE-2026-87491 — Chrome build state and un-relaunched updates\nlet fixed = dynamic([\"153.0.8010.36\",\"153.0.8010.37\"]);\nlet since = ago(7d);\nunion isfuzzy=true\n  (DeviceTvmSoftwareInventory\n   | where SoftwareVendor has \"google\" and SoftwareName has \"chrome\"\n   | extend Vulnerable = not(SoftwareVersion has_any (fixed))\n   | project DeviceName, Leg = iff(Vulnerable, \"vulnerable build installed\", \"patched build installed\"), Evidence = SoftwareVersion),\n  (DeviceProcessEvents\n   | where Timestamp > since\n   | where FileName =~ \"chrome.exe\"\n   | where isnotempty(ProcessVersionInfoProductVersion)\n   | summarize arg_max(Timestamp, ProcessVersionInfoProductVersion) by DeviceName\n   | extend Leg = iff(ProcessVersionInfoProductVersion has_any (fixed), \"running patched build\", \"STILL RUNNING VULNERABLE BUILD\")\n   | project DeviceName, Leg, Evidence = ProcessVersionInfoProductVersion)\n| summarize Legs = make_set(Leg), Detail = make_set(Evidence, 6) by DeviceName\n| extend NeedsRelaunch = Legs has \"patched build installed\" and Legs has \"STILL RUNNING VULNERABLE BUILD\"\n| sort by NeedsRelaunch desc, DeviceName asc",
   "DEFENDER XDR KQL — the same check across every Chromium-derived browser in the estate, since Edge, Brave, Opera and Vivaldi inherit the V8 defect and patch on their own schedules.\n\n// Chromium-family browser inventory for the V8 out-of-bounds write\nDeviceTvmSoftwareInventory\n| where SoftwareName has_any (\"chrome\",\"edge\",\"brave\",\"opera\",\"vivaldi\",\"chromium\")\n| where SoftwareName !has \"chromedriver\"\n| summarize Devices = dcount(DeviceId), Hosts = make_set(DeviceName, 20)\n    by SoftwareVendor, SoftwareName, SoftwareVersion\n| sort by SoftwareName asc, Devices desc",
   "A browser exploit reaching only inside the sandbox needs a second flaw to touch the host, so the follow-up question on any suspect device is whether a sandbox escape or local privilege escalation ran afterwards. Two exploited local escalations shipped in the same week — CVE-2026-85880 and CVE-2026-81963 in the September Patch Tuesday, both carried in this brief — which makes browser-to-SYSTEM chaining the pattern to look for rather than a hypothetical.",
   "Re-run the version query 48 hours after the push and treat any host still running a pre-153.0.8010.36 build as an exception with an owner, not a percentage."
  ],
  "source": "Google Chrome release advisory (Sep 8, 2026), NIST NVD, Help Net Security, BleepingComputer, SecurityWeek, The Hacker News, CyberInsider, Bitdefender, gbhackers, Windows Report, OffSeq Threat Radar",
  "sourceNote": "Sep 8–9, 2026"
 },
 "sapsep": {
  "eyebrow": "SAP · September 2026 Security Patch Day · CVE-2026-44756 · CVSS 10.0 · Sep 8, 2026",
  "title": "Three notes reach full compromise without a valid credential",
  "tags": [
   [
    "crit",
    "All Sectors"
  ...
  "overview": "The reason to act on this release rather than schedule it is where the flaws sit. Pathlock's assessment is that three notes this month reach full-compromise territory without a single valid credential. Those are a pre-authentication memory-corruption flaw in the request-processing path shared by essentially every NetWeaver AS ABAP and Java kernel and by Web Dispatcher 9.16, an unauthenticated remote-code-execution path in Commerce Cloud's Data Hub Adapter, and a pre-authentication trust bypass in the Message Server — the component every application server instance in a cluster implicitly trusts. The Message Server flaw is the one worth reading twice: Onapsis describes it as insufficient validation of component authenticity during registration, so the attack is not code execution against a service but the insertion of an attacker-controlled application server into a cluster that will then trust it. SAP reports no exploitation and no public proof-of-concept for any of these, which makes this a patching window rather than an incident — but the exposure question is not answered by patch level alone, because the affected surface is defined by kernel and Web Dispatcher version, and the CAP flaw lives in an npm dependency rather than in SAP's own shipped kernel. Note that the CVSS 10.0 Commerce Cloud note is a re-release, not new, and SAP's update to it states unmodified environments are not exposed by default.",
  "technical": [
   "CVE-2026-44756 (CVSS 10.0, SAP Note 3747649) — memory corruption in SAP Extended Passport processing. Pathlock attributes it to a missing boundary check during deserialization of EPP data, where an externally supplied length field is trusted without validation, and notes the SAP note's terminology spans buffer overflow, heap overflow and dangling-pointer conditions, and that the flawed condition can be triggered before authentication takes place.",
   "CVE-2026-44756 affected surface per Pathlock: every SAP NetWeaver AS ABAP and Java kernel below the patched level, plus standalone and embedded SAP Web Dispatcher version 9.16 specifically. Other Web Dispatcher versions, and the Web Dispatcher bundled with SAP HANA Extended Application Services, are not affected. securityonline.info records the versions as KRNL64NUC 7.22, KRNL64UC 7.22 to 8.04, WEBDISP 9.16 through 9.20 and KERNEL 7.22 through 9.20.",
   "CVE-2026-58240 (CVSS 9.8, SAP Note 3759472) — missing authentication check in the SAP NetWeaver Message Server, affecting KERNEL 9.16, 9.18, 9.19 and 9.20. Onapsis, which published the note with SAP's ORL team, states the Message Server insufficiently validates the authenticity of internal application server components during registration, so unauthenticated attackers with network access can register unauthorized components inside the application environment.",
   "CVE-2026-76969 (CVSS 9.4) — credential disclosure in multitenant applications using the SAP Cloud Application Programming Model library @sap/cds-mtxs, versions up to 1.18.3, 2.7.6, 3.9.6 and 4.0.2. securityonline.info reports the exposure occurs via specially crafted requests.",
   "CVE-2026-66768 — improper access control in SAP GUI for Java, the fourth Critical note per AiCybr. No CVSS score appears in the sources reviewed.",
   "SAP Note 3771065 (CVSS 10.0) is an update to a critical SAP Commerce Cloud (Data Hub Adapter) note first released on the August Patch Day, not a new September flaw. Onapsis reports the updated note states unmodified SAP Commerce Cloud environments are not exposed to the improper-authorization vulnerability by default, and provides an FAQ document to verify the setup.",
   "High-severity notes: CVE-2026-76958 (CVSS 8.5) XXE in SAP Integration Suite Trading Partner Management, which could expose sensitive files, enable server-side requests or disrupt XML processing; insecure deserialization in SAP NetWeaver Business Client; memory corruption in SAP NetWeaver Application Server for ABAP and ABAP Platform; CRLF injection in SAP Commerce Cloud Search and Navigation. Security Note 3772411 republishes CVE-2026-58243, a privilege escalation in SAP ABAP Developer Tools from the August Patch Day.",
   "Medium-severity notes cover SQL injection, SSRF, clickjacking, CSRF, information disclosure, authorization bypass and an Apache Log4j-related security misconfiguration. Named examples: CVE-2026-44766 (CVSS 6.5) SQL injection in SAP S/4HANA Intercompany Matching and Reconciliation, three CSRF flaws in SAP S/4HANA Finance for Advanced Payment Management, and CVE-2026-76962, a missing authorization check in the Manage Bank Chains application. cyberpress.org notes that although these are medium-rated, financial workflows and privileged business roles can raise their operational impact.",
   "securityonline.info reports SAP has recorded no active in-the-wild exploitation and no public proof-of-concept code for these specific vulnerabilities. Pathlock notes the severity ratings and CVSS scores reflect SAP's official Security Notes released Sep 8, 2026."
  ],
  "iocs": [],
  "iocNote": "No indicators published, and none are expected — SAP reports no exploitation and no public proof-of-concept for any note in this release. This is a patching and exposure exercise, not a hunt.",
  "mitigation": [
   "Patch Note 3747649 first on any SAP NetWeaver AS ABAP or Java kernel and on SAP Web Dispatcher 9.16. Pathlock's guidance is explicit that this one is unauthenticated, CVSS 10.0, and in the request-processing path almost every SAP system relies on.",
   "Confirm actual kernel patch levels fleet-wide rather than on flagship systems only — the affected surface for the two pre-authentication flaws is defined by kernel and Web Dispatcher version, not by product name.",
   "Treat internet-reachable and broadly reachable systems as the first wave: externally exposed Web Dispatcher instances and NetWeaver Message Servers affected by CVE-2026-44756 and CVE-2026-58240, then CAP multitenant applications and SAP GUI for Java.",
   "Segment the Message Server. CVE-2026-58240 is a trust bypass on component registration, so a Message Server reachable from general network segments means an attacker with network access can register an unauthorized application server into the cluster.",
   "For CVE-2026-76969, verify the @sap/cds-mtxs version with npm ls after deployment rather than assuming the dependency updated — the flaw is in a library, not in a SAP-shipped kernel.",
   "For SAP Note 3771065, use SAP's FAQ document to verify whether the Commerce Cloud setup is exposed at all; the updated note states unmodified environments are not exposed to the improper-authorization vulnerability by default.",
   "Use the SAP Security Note as the patch authority for each installed release rather than the CVE record, and re-test business-critical S/4HANA, Integration Suite and Commerce Cloud flows after the rebuild-and-redeploy cycle."
  ],
  "response": [
   "SENTINEL KQL — SAP application servers rarely carry endpoint telemetry, so the answerable question before patching is reachability: which Message Server and Web Dispatcher ports accept sessions from outside the SAP landscape. Both pre-authentication flaws in this release depend on that answer.\n\n// Reachability of SAP Message Server and Web Dispatcher from outside the landscape\nlet since = ago(30d);\nlet sapNets = dynamic([\"10.40.\",\"10.41.\"]);        // replace with your own SAP landscape ranges\nlet msPorts = dynamic([3600,3601,3602,3900,8100,8101]);   // sapms / message server HTTP\nlet wdPorts = dynamic([8000,8001,44300,44301,1080,1443]); // Web Dispatcher\nCommonSecurityLog\n| where TimeGenerated > since\n| where DestinationIP has_any (sapNets)\n| where DestinationPort in (msPorts) or DestinationPort in (wdPorts)\n| extend Component = case(DestinationPort in (msPorts), \"Message Server\", \"Web Dispatcher\")\n| extend Origin = iff(SourceIP has_any (sapNets), \"inside landscape\", \"OUTSIDE LANDSCAPE\")\n| summarize Sessions = count(), Ports = make_set(DestinationPort, 8), Actions = make_set(DeviceAction, 5)\n    by Component, Origin, SourceIP, DestinationIP\n| where Origin == \"OUTSIDE LANDSCAPE\" and Actions has_any (\"allow\",\"permit\",\"accept\")\n| sort by Sessions desc",
   "SENTINEL KQL — the Message Server flaw is a registration trust bypass, so the detection question after patching is whether an application server instance appeared that nobody deployed. Watch the registration and instance-list events rather than looking for exploit strings.\n\n// Unexpected SAP application server instance registration\nlet since = ago(30d);\nlet known = dynamic([\"sapapp01\",\"sapapp02\",\"sapapp03\",\"sapci01\"]);  // replace with your instance inventory\nunion isfuzzy=true\n  (Syslog\n   | where TimeGenerated > since\n   | where ProcessName has_any (\"sapms\",\"msg_server\",\"sapstartsrv\",\"dispatcher\")\n   | where SyslogMessage has_any (\"register\",\"registration\",\"attach\",\"connected\",\"instance\")\n   | extend Instance = extract(@\"(?i)(?:instance|host)[=:\\s]+([A-Za-z0-9_\\-\\.]+)\", 1, SyslogMessage)\n   | project TimeGenerated, Server = Computer, Leg = \"message server registration\", Instance, Evidence = SyslogMessage),\n  (Syslog\n   | where TimeGenerated > since\n   | where SyslogMessage has_any (\"EPP\",\"Extended Passport\",\"segmentation fault\",\"core dumped\",\"signal 11\")\n   | project TimeGenerated, Server = Computer, Leg = \"kernel fault or EPP error\", Instance = \"\", Evidence = SyslogMessage)\n| extend Unknown = Leg == \"message server registration\" and isnotempty(Instance) and not(Instance in~ (known))\n| summarize Events = count(), First = min(TimeGenerated), Last = max(TimeGenerated), Detail = make_set(Evidence, 5)\n    by Server, Leg, Instance, Unknown\n| sort by Unknown desc, Last desc",
   "DEFENDER XDR KQL — the CAP credential-disclosure flaw is a dependency problem, so check it where the dependency lives: build agents and Node hosts running @sap/cds-mtxs, not the ABAP stack.\n\n// @sap/cds-mtxs exposure on managed hosts\nlet since = ago(30d);\nunion isfuzzy=true\n  (DeviceTvmSoftwareInventory\n   | where SoftwareName has_any (\"cds-mtxs\",\"sap-cds\",\"@sap/cds\")\n   | project DeviceName, Leg = \"package in inventory\", Evidence = strcat(SoftwareName, \" \", SoftwareVersion)),\n  (DeviceProcessEvents\n   | where Timestamp > since\n   | where ProcessCommandLine has_any (\"cds-mtxs\",\"@sap/cds\",\"cds serve\",\"cds build\")\n   | project DeviceName, Leg = \"CAP tooling executed\", Evidence = ProcessCommandLine),\n  (DeviceFileEvents\n   | where Timestamp > since\n   | where FolderPath has \"node_modules\" and FolderPath has \"cds-mtxs\"\n   | project DeviceName, Leg = \"package files on disk\", Evidence = strcat(FolderPath, FileName))\n| summarize Hits = count(), Detail = make_set(Evidence, 6) by DeviceName, Leg\n| sort by DeviceName asc",
   "None of these queries is a detection for a known campaign — SAP reports no exploitation and no public proof-of-concept. Their purpose is to establish exposure and, for the Message Server, to give the cluster a baseline of legitimate instances before an unauthorized registration would be visible as an anomaly.",
   "Re-run the reachability query after the patch window. Where a Message Server or Web Dispatcher is still accepting sessions from outside the landscape, that is a segmentation finding independent of these CVEs and should be recorded as one."
  ],
  "source": "SAP Security Patch Day (Sep 8, 2026), Onapsis, Pathlock, AiCybr, CybersecurityNews, Cryptika, cyberpress.org, securityonline.info, Simply Secure Group",
  "sourceNote": "Sep 8–9, 2026"
 },
 "fortinetsep": {
  "eyebrow": "Fortinet · CVE-2026-84390 · CVE-2026-84388 · No reported exploitation · Sep 8, 2026",
  "title": "A hardcoded-secret auth bypass and a privileged-access agent that can be turned into a proxy",
  "tags": [
   [
    "high",
    "Information Technology"
  ...
  "overview": "Neither critical flaw is reported as exploited, and the reason to act anyway is what each one sits in front of. CVE-2026-84390 is sensitive information left in the source code of the FortiMonitorOnSight portal, which means an unauthenticated attacker can forge or reuse a JSON Web Token and be authenticated — a class of defect where the fix is the patch and nothing else, because there is no configuration that makes a hardcoded secret safe. CVE-2026-84388 is the more awkward one operationally: the vulnerable component is the Chrome extension of a privileged-access product, so the asset at risk is the browser session of exactly the administrators whose access FortiPAM exists to control, and the trigger is the user visiting a malicious website rather than any exposure of the appliance. It also cannot be closed by patching the appliance alone — Fortinet is explicit that FortiPAM must reach 1.9.1 or 1.8.4 and the extension must reach 8.0.1.123 or above, and an estate that patches only the server side will record the work as done while remaining exposed. Fortinet has published no indicators and reports no exploitation, so this is a patch-and-verify exercise; the verification that matters is browser-extension version state, which most vulnerability programmes do not collect.",
  "technical": [
   "CVE-2026-84390 (CVSS 9.6) — inclusion of sensitive information in source code in the FortiMonitorOnSight web portal. A remote, unauthenticated attacker could bypass authentication via a forged or reused JSON Web Token.",
   "CVE-2026-84388 (CVSS 9.1) — improper authentication in the Fortinet Privileged Access Agent Chrome extension. Fortinet states a remote, unauthenticated attacker may exploit it to proxy a user's browser traffic if the user visits a malicious website.",
   "Fortinet on remediation scope for CVE-2026-84388: \"Remediation for this issue required coordinated changes in two components: FortiPAM and the Fortinet Privileged Access Agent Chrome extension. To be fully secure, customers should upgrade FortiPAM to 1.9.1 or 1.8.4, and ensure the Chrome extension is at version 8.0.1.123 or above.\"",
   "High-severity flaws in the same release: CVE-2026-26084 in FortiSandbox, allowing access to sensitive information, and CVE-2026-84393 in the FortiOS and FortiProxy Agentless ZTNA portal, allowing machine-in-the-middle attacks. No CVSS scores for these appear in the sources reviewed.",
   "The remaining flaws are medium- and low-severity issues in FortiManager, FortiAnalyzer, FortiSandbox, FortiSOAR, FortiClient for Windows, FortiSIEM, FortiOS, FortiProxy and FortiPAM. Ten vulnerabilities in total.",
   "OffSeq records that no known exploitation in the wild has been reported by Fortinet for any flaw in this release."
  ],
  "iocs": [],
  "iocNote": "No indicators published. Fortinet reports no exploitation in the wild for any flaw in this release, and published no hashes, addresses or request signatures. The queries below establish version state and look for the traffic pattern the extension flaw would produce.",
  "mitigation": [
   "Patch FortiMonitorOnSight for CVE-2026-84390. A secret in shipped source code cannot be mitigated by configuration — until the portal is updated, any forged JWT is accepted.",
   "Complete both halves of the CVE-2026-84388 fix: FortiPAM to 1.9.1 or 1.8.4 AND the Fortinet Privileged Access Agent Chrome extension to 8.0.1.123 or above. Patching the appliance alone leaves the flaw open.",
   "Push the extension version through browser management policy rather than relying on users, and verify the deployed version — extension state is not usually covered by server-side patch reporting.",
   "Take the FortiMonitorOnSight portal off the public internet where remote access is not a requirement, as a standing control rather than a fix for this CVE.",
   "Apply the FortiSandbox and Agentless ZTNA portal fixes in the same window; the ZTNA flaw is a machine-in-the-middle issue on a component used to broker access."
  ],
  "response": [
   "DEFENDER XDR KQL — the flaw that matters most here is closed by a browser-extension version, which server-side patch reporting will not show. Check the extension inventory directly and pair it with the FortiPAM client version on the same hosts.\n\n// CVE-2026-84388 — Fortinet Privileged Access Agent extension and FortiPAM client version state\nlet fixedExt = \"8.0.1.123\";\nunion isfuzzy=true\n  (DeviceTvmBrowserExtensions\n   | where ExtensionName has_any (\"Fortinet\",\"Privileged Access Agent\",\"FortiPAM\")\n   | extend Vulnerable = tostring(ExtensionVersion) < fixedExt\n   | project DeviceName, Leg = iff(Vulnerable, \"EXTENSION BELOW 8.0.1.123\", \"extension patched\"),\n             Evidence = strcat(ExtensionName, \" \", ExtensionVersion, \" (\", BrowserName, \")\")),\n  (DeviceTvmSoftwareInventory\n   | where SoftwareVendor has \"fortinet\"\n   | where SoftwareName has_any (\"FortiPAM\",\"Privileged Access\",\"FortiClient\")\n   | project DeviceName, Leg = \"Fortinet client installed\", Evidence = strcat(SoftwareName, \" \", SoftwareVersion))\n| summarize Legs = make_set(Leg), Detail = make_set(Evidence, 6) by DeviceName\n| extend NeedsExtensionUpdate = Legs has \"EXTENSION BELOW 8.0.1.123\"\n| sort by NeedsExtensionUpdate desc, DeviceName asc",
   "SENTINEL KQL — the extension flaw proxies a user's browser traffic after they visit a malicious site, so the observable is administrator browsing that reaches an unexpected destination while the privileged-access session is live. Combine with the portal access view for CVE-2026-84390.\n\n// Fortinet portal access and privileged-session browsing anomalies\nlet since = ago(30d);\nlet fortiPorts = dynamic([443, 8443, 9443]);\nunion isfuzzy=true\n  (CommonSecurityLog\n   | where TimeGenerated > since\n   | where DestinationPort in (fortiPorts)\n   | where RequestURL has_any (\"fortimonitor\",\"onsight\",\"fortipam\") or DeviceProduct has_any (\"FortiPAM\",\"FortiMonitor\")\n   | extend HasAuthHeader = RequestURL has_any (\"token\",\"jwt\",\"bearer\")\n   | project TimeGenerated, Actor = SourceIP, Leg = iff(HasAuthHeader, \"portal request carrying token material\", \"portal request\"), Evidence = strcat(RequestURL, \" -> \", DestinationIP)),\n  (DeviceNetworkEvents\n   | where Timestamp > since\n   | where InitiatingProcessFileName in~ (\"chrome.exe\",\"msedge.exe\")\n   | where isnotempty(RemoteUrl)\n   | summarize Connections = count() by DeviceName, RemoteUrl, bin(Timestamp, 1h)\n   | where Connections > 200\n   | project TimeGenerated = Timestamp, Actor = DeviceName, Leg = \"sustained high-volume browser destination\", Evidence = strcat(RemoteUrl, \" x\", Connections))\n| summarize Events = count(), First = min(TimeGenerated), Last = max(TimeGenerated), Detail = make_set(Evidence, 6)\n    by Actor, Leg\n| sort by Last desc",
   "Neither query detects a known campaign — Fortinet reports no exploitation. The first establishes whether the estate is actually remediated, which for CVE-2026-84388 depends on browser-extension state rather than appliance version. The second gives a baseline for privileged-administrator browsing so that proxied traffic would stand out later.",
   "Scope the population that matters before running either query: the accounts using the Privileged Access Agent are, by definition, the estate's privileged administrators, so a small number of hosts carries most of the risk here."
  ],
 ...
 "shieldbreak": {
  "status": "updated",
  "conf": "Vendor patch confirmed for CVE-2026-69414 (Malware Protection Engine 1.1.26080.3); the bypass is researcher-published with public PoC and no Microsoft statement — The Hacker News, securityonline.info",
  "confNote": "High confidence that CVE-2026-69414 is patched in engine 1.1.26080.3 and that a public proof-of-concept bypassing that patch exists: The Hacker News reports both, and securityonline.info confirms the details and PoC are public. Moderate confidence in the scope of the bypass — \"all supported versions of the desktop operating system\" and \"arbitrary file read as SYSTEM on the latest version of Windows\" are the researcher's claims, repeated in reporting but not independently verified in the sources reviewed, and Microsoft has neither confirmed nor assigned a CVE. No in-the-wild exploitation of either ShieldBreak or ShieldCrash has been reported. The exact patch date for 1.1.26080.3 is given only as \"days\" before the Sep 8–9 ShieldCrash publication",
  "iocDate": "Sep 9, 2026 — CVE-2026-69414 patched in engine 1.1.26080.3; ShieldCrash PoC public, no patch, no CVE",
  "admiralty": "A2",
  "severity": 5,
  "cvss": null,
  "sectors": [
 ...
 "ukcsrb": {
  ...
  "attack": [
   "N/A — policy item, no adversary technique"
  ]
 },
 "ciscosep": {
  "status": "ongoing",
 ...
 "chrome87491": {
  "status": "new",
  "conf": "Vendor-confirmed exploitation with no published detail — Google Chrome advisory, corroborated by NVD and across Help Net Security, BleepingComputer, SecurityWeek and The Hacker News",
  "confNote": "High confidence that the flaw is exploited in the wild: Google states an exploit exists and shipped the fix, and NVD carries the description. Everything beyond that is absent — no actor, no targeting, no exploitation chain, no indicators — and Google says detail stays restricted until most users have updated. Severity is reported inconsistently: Google rates it Medium, BleepingComputer describes it as high-severity, and no CVSS score appears in the sources reviewed. Whether a sandbox escape was chained is not stated, so impact beyond in-sandbox code execution is unknown",
  "iocDate": "Sep 8, 2026 — patched; no indicators published",
  "admiralty": "A1",
  "severity": 4,
  "cvss": null,
  "sectors": [
 ...
 "sapsep": {
  "status": "new",
  "conf": "Vendor advisory — SAP Security Patch Day notes of Sep 8, 2026, with independent analysis from Onapsis (co-author of one note) and Pathlock",
  "confNote": "High confidence in the vulnerability facts: they come from SAP's own Security Notes, and Onapsis co-published Note 3759472 with SAP's ORL team. No exploitation is reported and no public proof-of-concept exists, per securityonline.info, so the risk is prospective. Two reporting caveats: the note count is consistently 19 plus one update across outlets, but the Critical count is given as four by AiCybr while other outlets enumerate three plus the re-released Commerce Cloud note, and CVE-2026-66768 in SAP GUI for Java carries no CVSS score in any source reviewed. The CVSS 10.0 Commerce Cloud note is an August re-release, not a new September flaw, and SAP's update states unmodified environments are not exposed by default",
  "iocDate": "Sep 8, 2026 — notes released; no exploitation, no indicators",
  "admiralty": "A2",
  "severity": 5,
  "cvss": 10,
  "sectors": [
 ...
 "fortinetsep": {
  "status": "new",
  "conf": "Vendor advisory — Fortinet PSIRT, reported by SecurityWeek and corroborated by OffSeq and CloudLink",
  "confNote": "High confidence in the vulnerability facts and the remediation versions, which come from Fortinet's own advisories and are quoted consistently across outlets. No exploitation is reported by Fortinet and no indicators were published, so the risk is prospective. Affected version ranges for the two high-severity flaws — CVE-2026-26084 in FortiSandbox and CVE-2026-84393 in the Agentless ZTNA portal — are not stated in the reporting reviewed and should be read from Fortinet's advisories directly. No CVSS scores were published for those two in any source reviewed",
  "iocDate": "Sep 8, 2026 — patches released; no exploitation, no indicators",
  "admiralty": "A2",
  "severity": 4,
  "cvss": 9.6,
  "sectors": [
